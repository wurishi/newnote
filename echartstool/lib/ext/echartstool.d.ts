...
declare module entitas {
    ...
    class SeriesTypeComponent implements IComponent {
      public type:string;public folder:any;public subFolder:any[];
    }
...
declare module echartstool {
     ...
     */
    class Pools {
        static get allPools(): Array<entitas.Pool>;
        static get pool(): entitas.Pool;
    }
}
declare module entitas {
    interface IMatcher {
...
declare module entitas {
    ...
    class Entity {
        ...
        addSeriesType(type:string, folder:any, subFolder:any[]): Entity;
        replaceSeriesType(type:string, folder:any, subFolder:any[]): Entity;
