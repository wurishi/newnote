...
declare module entitas.utils {
   ...
   class MovableComponent implements IComponent {
   }
   ...
   class InteractiveComponent implements IComponent {
   }
...
/** Matcher Extensions for test */
    ...
    static _matcherMovable;
    static Movable: Matcher;
    ...
    static _matcherInput;
    static Input: Matcher;
    

    static _matcherInteractive;
    static Interactive: Matcher;
...
static movableComponent: MovableComponent;
isMovable: boolean;
...
setDestroy(value: boolean);
      ...
      static _inputComponentPool;
      static clearInputComponentPool();
      input: InputComponent;
      hasInput: boolean;
      addInput(x:number, y:number);
      replaceInput(x:number, y:number);
      removeInput();
      

static interactiveComponent: InteractiveComponent;
