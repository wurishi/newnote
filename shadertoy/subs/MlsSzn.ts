...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // sphere animation
    Ellipsoid sph = Ellipsoid( vec3(0.0,0.0,0.0),//vec3(0.0,0.25,0.0) + vec3(1.0,0.5,1.0)*cos( iTime*1.0 + vec3(2.0,1.0,1.0) + 0.0 )*vec3(1.5,0.5,1.0), 
                               vec3(1.5,0.6,1.5) + vec3(1.0,0.4,1.0)*cos( iTime*3.0 + vec3(0.0,0.71,2.71) ) );
