...
//       The use of densely packed sphere tiling is inspired by @Shane's Cellular Tiling 4scXz2
...
//	return im0; // this one is always good, we have just calculated it
 ...
 #define IMAGE \
  ...
  { \
	  ...
	  fragColor.a = 1.0; /* remember we have the depth in alpha, png save will go weird so clear */ \
  }
#endif
`;
